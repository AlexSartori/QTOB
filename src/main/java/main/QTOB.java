...
public class QTOB {
    ...
    final static int NWK_TIMEOUT_MS = MAX_NWK_DELAY_MS*N_REPLICAS + 200;
    final static int HEARTBEAT_DELAY_MS = 700;
    final static int HEARTBEAT_TIMEOUT_MS = HEARTBEAT_DELAY_MS + MAX_NWK_DELAY_MS*N_REPLICAS + 200;
